...
class AdvancedModifiableKeyStoreDecorator extends ModifiableKeyStoreDecorator {
    ...
    private static char[] resolveKeyPassword(final KeyStoreService keyStoreService, final ExceptionSupplier<CredentialSource, Exception> credentialSourceSupplier) throws OperationFailedException {
        try {
