...
public class StopRecordCommand implements Command<CLICommandInvocation> {
    ...
    @Option(required = false, name = "transient", activator = TransientOptionActivator.class, hasValue = false)
    private boolean trans;

    @Option(required = false, converter = FileConverter.class, completer = FileCompleter.class)
    private File export;
    ...
    public CommandResult execute(CLICommandInvocation commandInvocation) throws CommandException, InterruptedException {
        ...
        try {
            crCF.run(commandInvocation, store, trans, export);
