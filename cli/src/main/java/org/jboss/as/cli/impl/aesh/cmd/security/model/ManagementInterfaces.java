...
public class ManagementInterfaces {
    ...
    private static void enableHTTPS(String secureSocketBinding, SSLSecurityBuilder security) throws OperationFormatException {
        security.getSteps().add(writeInterfaceAttribute(Util.HTTP_INTERFACE, Util.SSL_CONTEXT, security.getServerSSLContext().getName()));
        security.getSteps().add(writeInterfaceAttribute(Util.HTTP_INTERFACE, Util.SECURE_SOCKET_BINDING, secureSocketBinding));
    }
    ...
    private static void enableNativeSSL(String managementInterface, CommandContext ctx,
        ...
        security.getSteps().add(writeInterfaceAttribute(managementInterface, Util.SSL_CONTEXT, security.getServerSSLContext().getName()));
    }
