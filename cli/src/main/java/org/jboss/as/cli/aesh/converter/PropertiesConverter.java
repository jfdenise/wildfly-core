 ...
 */
public class PropertiesConverter implements Converter<ModelNode, CliConverterInvocation> {

    public static PropertiesConverter INSTANCE = new PropertiesConverter();
    ...
    public ModelNode convert(CliConverterInvocation converterInvocation) throws OptionValidatorException {
        ...
        try {
            return ArgumentValueConverter.PROPERTIES.
                    fromString(converterInvocation.getCommandContext().
                            getLegacyCommandContext(), value);
