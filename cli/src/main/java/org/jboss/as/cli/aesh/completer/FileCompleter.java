...
public class FileCompleter implements OptionCompleter<CliCompleterInvocation> {
    ...
    public void complete(CliCompleterInvocation completerInvocation) {
        ...
        FilenameTabCompleter pathCompleter = Util.isWindows()
                ? new WindowsFilenameTabCompleter(completerInvocation.getCommandContext())
                : new DefaultFilenameTabCompleter(completerInvocation.getCommandContext());
        int cursor = pathCompleter.complete(completerInvocation.getCommandContext(),
