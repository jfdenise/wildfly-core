...
public class QuotesState extends DefaultParsingState {
    ...
    public static QuotesState QUOTES_EXCLUDED = new QuotesState(false);
    public static QuotesState QUOTES_INCLUDED = new QuotesState(true);
    public static QuotesState QUOTES_INCLUDED_KEEP_ESCAPES = new QuotesState(true, EscapeCharacterState.KEEP_ESCAPE);
    static {
        ParsingStaticClearer.add(QuotesState.class);
    }
