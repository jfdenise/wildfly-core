...
public abstract class AbstractReorderSASLCommand implements Command<CLICommandInvocation>, DMRCommand {
    static final String MECHANISMS_ORDER = "mechanisms-order";

    @Option(name = MECHANISMS_ORDER, required = true,
    ...
    public CommandResult execute(CLICommandInvocation commandInvocation) throws CommandException, InterruptedException {
        try {
            SecurityCommand.execute(commandInvocation.getCommandContext(), buildRequest(commandInvocation.getCommandContext()), noReload);
