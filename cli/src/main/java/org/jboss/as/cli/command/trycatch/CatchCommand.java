 ...
 * @author jfdenise
 */
@CommandDefinition(name = "catch", description = "", activator = CatchActivator.class)
public class CatchCommand implements Command<CliCommandInvocation> {
    ...
    public CommandResult execute(CliCommandInvocation commandInvocation)
        ...
        if (flow.isInTry()) {
            ...
            throw new CommandException("catch may appear only once after try and before finally");
        }
        return CommandResult.SUCCESS;
    }
}
