 ...
 */
public class NonObjectConverter implements Converter<ModelNode, CliConverterInvocation> {

    public static NonObjectConverter INSTANCE = new NonObjectConverter();

    private NonObjectConverter() {
    }
    ...
    public ModelNode convert(CliConverterInvocation converterInvocation) throws OptionValidatorException {
        ...
        try {
            return ArgumentValueConverter.NON_OBJECT.fromString(converterInvocation.
