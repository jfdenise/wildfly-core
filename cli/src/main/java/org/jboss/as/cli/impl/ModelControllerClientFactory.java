...
public interface ModelControllerClientFactory {
    ...
    ModelControllerClient getClient(ControllerAddress address, CallbackHandler handler,
            ...
            ConnectionCloseHandler closeHandler, ProtocolTimeoutHandler timeoutHandler, String clientBindAddress, Supplier<Boolean> userInterruption) throws IOException;
    ...
    ModelControllerClientFactory CUSTOM = new ModelControllerClientFactory() {
        ...
        public ModelControllerClient getClient(ControllerAddress address,
                ...
                final int connectionTimeout, final ConnectionCloseHandler closeHandler, ProtocolTimeoutHandler timeoutHandler, String clientBindAddress, Supplier<Boolean> userInterruption) throws IOException {
            Map<String, String> saslOptions = disableLocalAuth ? DISABLED_LOCAL_AUTH : ENABLED_LOCAL_AUTH;
            return new CLIModelControllerClient(address, handler, connectionTimeout, closeHandler, saslOptions, sslContext, fallbackSslContext, timeoutHandler, clientBindAddress, userInterruption);
        }};
