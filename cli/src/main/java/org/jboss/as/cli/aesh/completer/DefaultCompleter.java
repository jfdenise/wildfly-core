 ...
 * @author jdenise
 */
public class DefaultCompleter implements OptionCompleter<CliCompleterInvocation> {

    private final org.jboss.as.cli.impl.DefaultCompleter completer;

    public DefaultCompleter(org.jboss.as.cli.impl.DefaultCompleter completer) {
