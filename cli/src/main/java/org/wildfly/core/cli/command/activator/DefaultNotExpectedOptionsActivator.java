...
import static org.wildfly.core.cli.command.activator.ExpectedOptionsActivator.ARGUMENT_NAME;
 ...
 */
public abstract class DefaultNotExpectedOptionsActivator implements NotExpectedOptionsActivator {

    private final Set<String> options;

    protected DefaultNotExpectedOptionsActivator(String... opts) {
        options = new HashSet<>(Arrays.asList(opts));
    }

    protected DefaultNotExpectedOptionsActivator(Set<String> opts) {
        options = opts;
    }
