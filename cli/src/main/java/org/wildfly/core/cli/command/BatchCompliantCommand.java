...
public interface BatchCompliantCommand extends DMRCommand {
    ...
    interface BatchResponseHandler {
         ...
         */
        void handleResponse(ModelNode step, OperationResponse response) throws CommandException;
    }

    BatchResponseHandler buildBatchResponseHandler(CliCommandContext commandContext,
