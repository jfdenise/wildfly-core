...
public class AttachementTestCase {
    ...
    private static final String PATH = "/a/nice/attachement/path";
    ...
    private static final String VALUE = "{\n"
            + "    \"toto\": [\"a\", \"b\", \"c\"],\n"
            + "    \"titi_a\": \"" + PATH + "0\",\n"
            + "    \"tata_a\": [\"" + PATH + "1\", \"" + PATH + "2\", \"/a/nice/attachement/path3\"],\n"
            + "    \"tutu\": {\n"
            + "        \"p1_a\": \"" + PATH + "4\",\n"
            + "        \"p2_a\": \"" + PATH + "5\",\n"
            + "        \"p3\": [\n"
    ...
    public void test1() throws CliInitializationException {
        ...
        for (String k : value.keys()) {
            Util.applyReplacements(k, value.get(k), req.get(k), req.get(k).get(Util.TYPE).asType(), attachements);
        }
        Assert.assertEquals("Should be equal", expected, value);
        Assert.assertEquals(11, attachements.getAttachedFiles().size());
        for (int i = 0; i < attachements.getAttachedFiles().size(); i++) {
            String p = attachements.getAttachedFiles().get(i);
