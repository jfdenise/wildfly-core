...
public class ThreadMXBeanThreadsAllocatedBytesHandler implements OperationStepHandler {
    ...
    static final OperationDefinition DEFINITION = new SimpleOperationDefinitionBuilder(PlatformMBeanConstants.GET_THREADS_ALLOCATED_BYTES, PlatformMBeanUtil.getResolver(PlatformMBeanConstants.THREADING))
