...
class AbstractExtendedMBean {
    ...
    AbstractExtendedMBean(String name) throws OperationFailedException {
        try {
    ...
    Object getAttribute(String attributeName) throws OperationFailedException {
        try {
    ...
    void setAttribute(String attributeName, Object value) throws OperationFailedException {
        try {
    ...
    Object invokeOperation(String opName, Object[] values, String[] signature) throws OperationFailedException {
        try {
            return ManagementFactory.getPlatformMBeanServer().
