...
import org.jboss.as.cli.impl.BootCommandContext;
...
public class AppendTestCase {
    ...
    public void testAppendNonExistingFileBoot() throws Exception {
        CommandContext ctx = new BootCommandContext(null);
    ...
    public void testAppendExistingFileBoot() throws Exception {
        testAppend("tmpfile", "echo foo", "foo", new BootCommandContext(null));
    }

    @Test
    public void testAppendTwiceExistingFileBoot() throws Exception {
        doTestAppendTwiceExistingFile(new BootCommandContext(null));
    }
    ...
    public void testAppendFileRelativePathBoot() throws Exception {
        doTestAppendFileRelativePath(new BootCommandContext(null));
    }
    ...
    public void testAppendFileAbsolutePathBoot() throws Exception {
        doTestAppendFileAbsolutePath(new BootCommandContext(null));
    }
    ...
    public void testAppendSpecialCharsInFileBoot() throws Exception {
        testAppend("tmpfile", "echo üúö", "üúö", new BootCommandContext(null));
    }
    ...
    public void testAppendFileNameSpecialCharsBoot() throws Exception {
        testAppend("tmpüúö", "echo foo", "foo", new BootCommandContext(null));
    }
    ...
    public void testAppendFileNameQuestionMarkBoot() throws Exception {
        ...
        if (!Util.isWindows()) {
            testAppend("tmp?file", "echo foo", "foo", new BootCommandContext(null));
        }
    }
    ...
    @Test
    @Ignore //Parsing of aesh escape this corner case.
