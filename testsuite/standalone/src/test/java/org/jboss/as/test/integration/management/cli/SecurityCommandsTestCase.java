...
public class SecurityCommandsTestCase {
    ...
    public void testEnableSSLInteractiveNoConfirm() throws Exception {
        ...
        try {
            ...
            Assert.assertTrue(cli.pushLineAndWaitForResults("", "Distinguished Name"));
            //Loop until DN has been provided.
            Assert.assertTrue(cli.pushLineAndWaitForResults("", "Distinguished Name"));
            Assert.assertTrue(cli.pushLineAndWaitForResults("", "Distinguished Name"));

            //Loop until value is valid.
            Assert.assertTrue(cli.pushLineAndWaitForResults("CN=CA", "Validity"));
            ...
            Assert.assertTrue(cli.pushLineAndWaitForResults("y", "Client certificate"));

            //Loop until certificate file exists
            Assert.assertTrue(cli.pushLineAndWaitForResults("foo.bar", "Client certificate"));
    ...
    private void testEnableSSLInteractiveConfirm(String mgmtInterface) throws Exception {
        ...
        try {
            ...
            Assert.assertTrue(cli.pushLineAndWaitForResults(GENERATED_KEY_STORE_PASSWORD, "Distinguished Name"));
            Assert.assertTrue(cli.pushLineAndWaitForResults("CN=CA", "Validity"));
            Assert.assertTrue(cli.pushLineAndWaitForResults("", "Alias"));
    ...
    private static void checkModel(String mgmtInterface, String keyStoreFile, String relativeTo,
        ...
        ModelNode expectedSSLContext = buildSSLContextResource(trustManagerName, keyManagerName, trustManagerName != null, trustManagerName != null);
